/*
Define and color (BLACK) the models of (some) windows,
and instance them within the building model.
*/
...
balcony = STRUCT([T([1,2,3])([1.6,.2,1.2])(balcony_bars), T([1])([-.1])(balcony_wall), T([1,2,3])([1.6,1.5,1.2])(balcony_bars)]);
...
var south = STRUCT([south0, south1, south2, south3, T([2,3])([.35+.4+8,4+.5+3.2+.65])(CUBOID([.4, 1.5,3.2]))]);
