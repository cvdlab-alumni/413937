/**
 * The previous model of human settlement must also contain a simplified road 
 * system consisting of two families of orthogonal rectangles. Each generated 
 * village will therefore consists of a set of parallel parallelepipeds 
 * (buildings) and mutually orthogonal rectangles (the roads).
 */
...
/*
 * Function to generate roads from initial and final point:
 */
...
/*
 * density must be the same of placeBuildings.
 */
var roads = [];
